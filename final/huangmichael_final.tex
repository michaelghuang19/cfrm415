...
By put-call parity with no dividend, we know that the American call option is always optimal to be exercised at expiry, we can say that it is the same price as the European call option, that is, \framebox[1.1\width]{$\mathbf{124.23224257130119}$}
